		 ...
		 <div class="navbar-header">
            ...
            <div class="navbar-default sidebar" role="navigation">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="studclass.php">My Class</a>
                        </li>
						<li>
                            <a href="studasses.php">Results</a>
                        </li>
						<li>
...
$db=mysqli_connect('localhost','root','','ecole') or die(mysqli_error());
				 ...
				 $strsql1="SELECT * FROM users WHERE uname='$uname' && accttype='student'"or die("mysqli_error()");
...
<img src="i/reg.png" width="100px"><br>
				...
				<?php echo $email ?></td></tr></table>
                                  ...
                                  <a href="#" style="text-decoration:none"> Update Profile</a>   
