...
while($row=mysqli_fetch_array($rs)){
	...
	//	$lname=$row['lname'];
						...
						<li align="center">
						<a href="classsel.php?classsel=<?php echo $name ?>" ><?php echo $name ?></a>
						</li>
						<?php } ?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <!-- /.row --><form action="testa.php" method="POST">
									   ...
									   <td width="100px" align="center">Sex</td><td width="200px" align="center">Class</td></tr>
				<?php
$db=mysqli_connect('localhost','root','','ecole') or die(mysqli_error());
 $strsql="SELECT * FROM usersch WHERE schuser='$uname' && class='$mclass'"or die("mysqli_error()");
$rs=mysqli_query($db,$strsql);
$counter=0;
while($row=mysqli_fetch_array($rs)){
	$fname=$row['fname'];
...
?>
		...
		<li><a href="<?php echo $admno.".php"?>"><?php echo $counter ?></td><td width="300px" align="center"><ul class="nav" id="side-menu">
		 <li><a href="testa.php/?testa='<?php echo $admno ?>'"><?php echo $admno ?></td>
		 <td style="margin-bottom:10px; word-spacing:.2in;" align="left" width="500px" ><ul class="nav" id="side-menu">
		 <li><a href="testa.php/?testa='<?php echo $admno ?>'" name="testa"><?php echo  $fname." ".$oname." ".$lname ?></td>
		 <td width="100px" align="center"><?php echo $sex ?></td><td width="200px" align="center"><?php echo $class ?></td></a></li></ul></tr><?php } ?></table>
