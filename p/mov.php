...
$db=mysqli_connect('localhost','root','','ututor') or die(mysqli_error());
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><?php echo "Movies" ?></h1>
                    </div>
                </div>
                <!-- /.row -->
									   ...
									   <a href=#>
										      <h4 class="timeline-title">The Ghost</h4> </a>
												 <img src="i/home.png"> 
                                            <p><small class="text-muted">dir Kamal</small>
                                            </p>
                                        </div>									
										...
										<div>
										<p><small class="text-muted"><i class="fa fa-user"></i> srk, salman khan,  </small><div class="col-xs-3">
