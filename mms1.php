...
$strsql="SELECT * FROM class WHERE schuname='$k'"or die("mysqli_error()");
$rs=mysqli_query($db,$strsql);
$clacounter=0;
while($row=mysqli_fetch_array($rs)){
...
<div align="right" style=" float:right; display:none" id="tcherform">
<table >
...
while($row=mysqli_fetch_array($rs)){
	...
	<div>
	<br>
	<p  align="bottom" style="position:bottom" >
<img src="p/i/home.png"><br>
<img src="p/i/cat.png">
</p>
	</div>				
